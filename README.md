...
## MobileNet V2 usage
The mobile visual recognition is done more efficiently with classification. The MobileNetV2 is part of TensorFlow-Slim Image  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjUyNDIwNDM3LDU2OTU2OTQ3NF19
-->